...
CREATE TABLE "tasks" (
	...
	"situation" text DEFAULT 'not_started' NOT NULL,
	"description" text,
...
ALTER TABLE "team_users" ADD CONSTRAINT "team_users_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;